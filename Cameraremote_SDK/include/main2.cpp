...
class MyDeviceCallback : public SCRSDK::IDeviceCallback
{
    ...
    {
        CrChar serialNum[(SCRSDK::USB_SERIAL_LENGTH + 1)] = {0};
        memcpy(serialNum, L"CFB7A03380EF", sizeof(serialNum));
        SCRSDK::ICrCameraObjectInfo *pCam = nullptr;
        SCRSDK::CrError err = SCRSDK::CreateCameraObjectInfoUSBConnection(&pCam, SCRSDK::CrCameraDeviceModel_ILX_LR1, (CrInt8u *)serialNum);
